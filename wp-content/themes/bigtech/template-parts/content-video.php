 ...
 */
    ...
    $bigtech_video_url = function_exists( 'get_field' ) ? get_field( 'fromate_style' ) : NULL;
...
<?php if ( is_single() ) : ?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'blog-post-item format-video' );?>>
        ...
        <div class="blog-post-thumb position-relative">
            ...
            <?php if(!empty($bigtech_video_url)) : ?>
                <a href="<?php print esc_url( $bigtech_video_url );?>" class="video--icon popup-video"><i class="fas fa-play"></i></a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
